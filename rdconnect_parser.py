...
entity_names = ["rd_connect_test_dir"]
...
rd_connect_test_dir = workbook.add_worksheet(entity_names[0])
...
packages.write("A2", "rd_connect_test")
packages.write("B2", "rd_connect_test")
...
entities.write("A2", "dir")
entities.write("B2", "rd_connect_test")
